...
class TenantTest(TestCase):
    def setUp(self):
        ...
        self.expected_tenant_link = TenantsLink(href="HREF", type_="TYPE", rel="REL")
    ...
    def test_json_to_obj(self):
        ...
        assert self.expected_tenants == Tenants._json_to_obj(self.tenants_serialized_str)

    def test_list_to_obj(self):
        assert self.expected_tenants == Tenants._list_to_obj(self.tenant_list_dict)