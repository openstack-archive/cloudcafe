...
class FloatingIPClient(AutoMarshallingHTTPClient):
    ...
    def list_floating_ip_details(self, floating_ip_id, fixed_ip_address=False,
        ...
        filter_by = dict([(prop, vars()[prop]) for prop in self.PARAM_FILTERS])

        # Translate any params differ between the model specific (python) keys
        # and the actual response "key".
    ...
    def _translate_filter_params_dict(self, params_dict):
        """
