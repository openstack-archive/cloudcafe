...
from cloudcafe.networking.networks.common.constants import ExpectedResponses
...
class NetworkingBaseBehaviors(BaseBehavior):
    ...
    def check_response(self, resp, status_code, label, message,
        ...
        @return: OK if the response is the expected or the error message
        @rtype: string
        """
        response_msg = None
        if network_id:
        ...
        if not resp_type == requests.models.Response:
            ...
            response_msg = ExpectedResponses.RESPONSE_OK
