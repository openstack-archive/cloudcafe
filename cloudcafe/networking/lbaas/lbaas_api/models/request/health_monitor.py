...
class CreateHealthMonitor(AutoMarshallingModel):
    ...
    def _obj_to_xml(self):
        ...
        element.set('delay', str(self.delay))
        element.set('timeout', str(self.timeout))
        element.set('max_retries', str(self.max_retries))
        if self.http_method is not None:
            element.set('http_method', self.http_method)
        if self.url_path is not None:
            element.set('url_path', self.url_path)
        if self.expected_codes is not None:
            element.set('expected_codes', self.expected_codes)
...
class UpdateHealthMonitor(AutoMarshallingModel):
    ...
    def _obj_to_xml(self):
        ...
        if self.delay is not None:
            self.attr_dict['delay'] = str(self.delay)
        if self.timeout is not None:
            self.attr_dict['timeout'] = str(self.timeout)
        if self.max_retries is not None:
            self.attr_dict['max_retries'] = str(self.max_retries)
        if self.admin_state_up is not None:
            self.attr_dict['admin_state_up'] = str(self.admin_state_up)
