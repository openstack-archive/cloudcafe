...
class ObjectStorageAPI_Behaviors(BaseBehavior):
    ...
    def get_swift_info(self):
        ...
        """
        # This method is used by the reqiured_features decorator, if a global
        # is not used here, it will cause an API call to swiftinfo for every
        # test that is decorated.
