...
class _VolumesAPICommonModel(AutoMarshallingModel):
    obj_model_key = None
    kwarg_map = {}
...
class _VolumesAPICommonListModel(AutoMarshallingListModel):
    list_model_key = None
    ObjectModel = None
...
class Volume(_VolumesAPICommonModel):
...
class VolumeSnapshot(_VolumesAPICommonModel):
...
class VolumeType(_VolumesAPICommonModel):
...
class VolumeList(_VolumesAPICommonListModel):
    list_model_key = 'volumes'
    ObjectModel = Volume


class VolumeSnapshotList(_VolumesAPICommonListModel):
    list_model_key = 'snapshots'
    ObjectModel = VolumeSnapshot


class VolumeTypeList(_VolumesAPICommonListModel):
