...
class _BaseModel(AutoMarshallingModel):
    obj_model_key = None
    kwarg_map = {}
...
class _BaseListModel(AutoMarshallingListModel):
    list_model_key = None
    ObjectModel = None
...
class VolumeSnapshot(_BaseModel):
...
class VolumeList(_BaseListModel):
    list_model_key = 'volumes'
    ObjectModel = Volume


class VolumeSnapshotList(_BaseListModel):
    list_model_key = 'snapshots'
    ObjectModel = VolumeSnapshot


class VolumeTypeList(_BaseListModel):
