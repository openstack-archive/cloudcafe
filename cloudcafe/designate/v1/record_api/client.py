...
from cloudcafe.designate.v1.record_api.models.responses import RecordResponse


class RecordsApiClient(AutoMarshallingRestClient):
    ...
    def _get_domain_url(self, domain_id):
        return "{0}/v1/domains/{1}".format(self.url, domain_id)
    ...
    def update_record(self, domain_id=None, name=None, type=None, data=None,
        ...
        """PUT v1/domains/{domainID}/records/{record_id}"""
