...
class Node(AutoMarshallingModel):
    ...
    def _dict_to_obj(cls, json_dict):
        ...
        if 'properties' in json_dict:
            properties = Properties._dict_to_obj(json_dict.get('properties'))

        driver_info = None
        if 'driver_info' in json_dict:
            driver_info = DriverInfo._dict_to_obj(json_dict.get('driver_info'))
        ...
        if 'extra' in json_dict:
            extra = Extra._dict_to_obj(json_dict.get('extra'))
