...
class VerificationsClient(BarbicanRestClient):
    ...
    # no update (PUT) for verifications.  If it is ever supported then we will
    # want something like this:
    # def update_verification(self, verification_id, resource_type=None,
    #                         resource_ref=None, resource_action=None,
    #                         impersonation_allowed=False):
    #    """
    #    PUT http://.../v1/{tenant_id}/verifications/{verification_uuid}
    #    Update a verification
    #    """
    #    remote_url = self._get_verification_url(verification_id)
    #    data = SOMETHING INTERESTING HERE
    #    resp = self.request('PUT', remote_url, data=data)
    #    return resp
