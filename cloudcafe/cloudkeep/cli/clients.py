...
from cloudcafe.cloudkeep.cli.models.responses import SecretCLIModel
from cloudcafe.cloudkeep.cli.models.responses import OrderCLIModel
...
class BarbicanCLIClient(BaseCommandLineClient):
    ...
    def get(self, entity_type, hateos_ref):
        ...
        if entity_type == BarbicanEntityType.ORDER:
            model = OrderCLIModel
