...
class ImagesBehaviors(BaseBehavior):
    ...
    def create_image_via_task(self, image_properties=None, import_from=None,
        ...
        """
        @summary: Create new image via create new task method and add it for
        deletion
        """
    ...
    def create_images_via_tasks(self, image_properties=None, import_from=None,
                                import_from_format=None, count=1):
        """
        @summary: Create new images via create new task method and add them for
        deletion
        """
