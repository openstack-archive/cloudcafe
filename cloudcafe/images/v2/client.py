...
class ImagesClient(AutoMarshallingRestClient):
    ...
    def get_image(self, id_, requestslib_kwargs=None):
        """@summary: Get a single image"""

        url = '{0}/images/{1}'.format(self.base_url, id_)
    ...
    def update_image(self, id_, replace=None, add=None, remove=None,
    ...
    def delete_image(self, id_, requestslib_kwargs=None):
    ...
    def store_image_file(self, id_, file_data, requestslib_kwargs=None):
        """@summary: Store image file data on given image id"""

        url = '{0}/images/{1}/file'.format(self.base_url, id_)
        headers = {'Content-Type': 'application/octet-stream'}
        return self.request('PUT', url, headers=headers, data=file_data)

    def get_image_file(self, id_, requestslib_kwargs=None):
    ...
    def add_tag(self, id_, tag, requestslib_kwargs=None):
        """@summary: Add a tag to an image"""

        url = '{0}/images/{1}/tags/{2}'.format(self.base_url, id_, tag)
        return self.request('PUT', url, requestslib_kwargs=requestslib_kwargs)

    def delete_tag(self, id_, tag, requestslib_kwargs=None):
    ...
    def delete_member(self, id_, member_id):
