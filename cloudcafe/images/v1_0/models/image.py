...
class Image(AutoMarshallingModel):
    ...
    def __init__(self, id=None, status=None, name=None, container_format=None,
                 ...
                 min_disk=None, size=None, deleted=None, protected=None, is_public=None,
                 properties=None, created_at=None, updated_at=None, deleted_at=None, members_list=None):
    ...
    def _xml_to_obj(cls, serialized_str):
        ...
        passed in.'''
        raise NotImplementedError("Glance does not serve XML-formatted resources.")
