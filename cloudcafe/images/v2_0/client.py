...
class ImageClient(AutoMarshallingRestClient):
    ...
    def create_image(self, id_=None, name=None, visibility=None,
        ...
        image_obj = Image(
            id_, name, visibility, status, protected,
            tags, checksum, size, created_at, updated_at, file_,
            self_, schema, container_format, disk_format, min_disk,
            min_ram, kernel_id, ramdisk_id)

        serialized_obj = image_obj._obj_to_json()
