    ...
    def _extract_data_from_list(cls, results_list, domain_model_type,
        ...
        for result in results_list[1:]:
            ...
            for i in range(0, len(results_list[0])):
                entity_dict[results_list[0][i]] = result[i]
...
class EventDetail(AutoMarshallingModel):
    ...
    def __init__(self, event_id, routing_key_type, when, event_name,
                 host_name, state, old_state, old_task):
        """
