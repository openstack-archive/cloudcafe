...
class TenantLimits(AutoMarshallingModel):
    ...
    def __repr__(self):
        ...
        for prop in self.__dict__:
            ...
            return "limits: [{properties}]".format(properties=', '.join(values))
    ...
    def _json_to_obj(cls, serialized_str):
        ...
        absolute_limits = AbsoluteLimits._json_to_obj(json_dict['limits']['absolute'])
        return TenantLimits(rate_limits=rate_limits, absolute_limits=absolute_limits)
    ...
    def _xml_to_obj(cls, serialized_str):
        ...
        cls._remove_xml_etree_namespace(absolute_list, Constants.XML_API_ATOM_NAMESPACE)
