...
class Result(object):
    ...
    Attributes:
        ...
        failure (bool): Convenience attribute for 'not success'
    ...
    def task(cls, data):
        ...
        Example:
            ...
            if condition:
                ...
                return cls.failed('Condition was False')
        """
        raise NotImplementedError('Override this method in a subclass')

    @classmethod
    def succeeded(cls, payload):
    ...
    def failed(cls, error_msg):
        ...
        Returns:
            Result: Failure result with a dict payload
                ...
                message.
        """
        return Result(success=False, payload={cls.__name__: error_msg})
    ...
    def run_pipeline(self, data, print_summary=True):
        ...
        Args:
            data (dict): Data to process. The dict must include,
                ...
                the pipeline tasks.
            print_summary (bool, optional): Print the result
                summary at the conclusion of the run if True,
                else print nothing. Defaults to True.
