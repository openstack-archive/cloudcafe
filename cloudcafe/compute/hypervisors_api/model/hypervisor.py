...
class Hypervisor(AutoMarshallingModel):
    ...
    def __init__(self, hyp_id=None, hypervisor_hostname=None,
        ...
        self.cpu_info = int(cpu_info)
        self.free_disk_gb = int(free_disk_gb)
        self.hypervisor_version = hypervisor_version
        self.disk_available_least = disk_available_least
        self.local_gb = int(local_gb)
        self.free_ram_mb = int(free_ram_mb)
        self.vcpus_used = int(vcpus_used)
        self.hypervisor_type = hypervisor_type
        self.local_gb_used = int(local_gb_used)
        self.memory_mb_used = int(memory_mb_used)
        self.memory_mb = int(memory_mb)
        self.current_workload = int(current_workload)
        self.vcpus = int(vcpus)
        self.running_vms = int(running_vms)
    ...
    @classmethod
    def _dict_to_obj(cls, hypervisors_dict):
        args = {
            'hyp_id': hypervisors_dict.get('id'),
            'hypervisor_hostname': hypervisors_dict.get('hypervisor_hostname'),
            'cpu_info': hypervisors_dict.get('cpu_info'),
            'free_disk_gb': hypervisors_dict.get('free_disk_gb'),
            'hypervisor_version': cls._int_to_version_str(
                hypervisors_dict.get('hypervisor_version')),
            'disk_available_least': hypervisors_dict.get(
                'disk_available_least'),
            'local_gb': hypervisors_dict.get('local_gb'),
            'free_ram_mb': hypervisors_dict.get('free_ram_mb'),
            'vcpus_used': hypervisors_dict.get('vcpus_used'),
            'hypervisor_type': hypervisors_dict.get('hypervisor_type'),
            'local_gb_used': hypervisors_dict.get('local_gb_used'),
            'memory_mb_used': hypervisors_dict.get('memory_mb_used'),
            'memory_mb': hypervisors_dict.get('memory_mb'),
            'current_workload': hypervisors_dict.get('current_workload'),
            'vcpus': hypervisors_dict.get('vcpus'),
            'running_vms': hypervisors_dict.get('running_vms'),
            'service': Service._dict_to_obj(hypervisors_dict.get('service'))
        }
...
class Hypervisors(AutoMarshallingModel):
...
class HypervisorsMin(AutoMarshallingModel):
