...
class EcMeta(AutoMarshallingModel):
    ...
    def _dict_to_obj(cls, json_dict):
        ...
        if 'block-device-mapping' in json_dict:
            ec_meta.block_device_mapping = Bdm._json_to_obj(json_dict)
        return ec_meta


class Bdm(AutoMarshallingModel):
