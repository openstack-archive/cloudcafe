...
from cloudcafe.compute.extensions.extensions_api.clients.extensions_client import ExtensionListClient
...
class ExtensionListComposite(BaseComputeComposite):
    ...
    def __init__(self, auth_composite):
        ...
        self.client = ExtensionListClient(**self.compute_auth_composite.client_args)
