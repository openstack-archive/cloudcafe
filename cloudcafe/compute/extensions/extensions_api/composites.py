...
from cloudcafe.compute.extensions.extensions_api.clients.extensions_client import ExtensionClient
...
class ExtensionListComposite(BaseComputeComposite):
    ...
    def __init__(self, auth_composite):
        ...
        self.client = ExtensionClient(**self.compute_auth_composite.client_args)
