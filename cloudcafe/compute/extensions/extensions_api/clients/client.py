...
class VolumeServersClient(AutoMarshallingHTTPClient):
    ...
    def __init__(self, url, auth_token, serialize_format=None,
        ...
        """
        super(VolumeServersClient, self).__init__(serialize_format,
                                                  deserialize_format)
    ...
    def create_server(self, name, flavor_ref, block_device_mapping_v2,
        ...
        server_request_object = CreateServer(
            ...
            disk_config=disk_config, dmin_pass=admin_pass, key_name=key_name,
