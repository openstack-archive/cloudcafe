...
class ServerBehaviors(BaseBehavior):
    ...
    def __init__(self, servers_client, servers_config,
                 images_config, flavors_config, volume_v2_servers_client=None):
        ...
        self.volume_v2_servers_client = volume_v2_servers_client
    ...
    def create_active_server(
            ...
            block_device_mapping=None, block_device=None):
        """
        ...
        for attempt in range(attempts):
            ...
            if block_device is None:
                ...
                resp = self.volume_v2_servers_client.create_server(
