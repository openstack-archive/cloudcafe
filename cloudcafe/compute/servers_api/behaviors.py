...
class ServerBehaviors(BaseBehavior):
    ...
    def create_server(
        ...
        @param networks: List of networks and their attributes
        @type networks: String
        @param key_name: User's public key
        @type key_name: String
        @param config_drive: Config Drive flag
        @type config_drive: String
        @param scheduler_hints: Data used by Scheduler filters
        @type scheduler_hints: String
        @param admin_pass: Admin Password of the server
