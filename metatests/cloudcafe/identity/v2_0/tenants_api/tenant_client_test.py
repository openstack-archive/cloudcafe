...
class TestTenantsClient(object):
    ...
    def setup_class(cls):
        ...
        cls.services_url = "{0}/v2.0/{1}/services".format(
            cls.url,
            cls.admin_extensions)
        cls.service_id = "SERVICE_ID"
        cls.service_url = "{0}/{1}".format(cls.services_url,
                                           cls.service_id)
    ...
    def test_create_service(self):
        HTTPretty.register_uri(
            HTTPretty.POST,
            self.services_url,
            body=self._build_create_service_expected_response())
    ...
    def _build_create_service_expected_response(self):
        return {"OS-KSADM:service": {
            "type": None,
            "name": "service-test-",
            "id": "2dc0a32bb169471f81b4451931cdd682"}}
