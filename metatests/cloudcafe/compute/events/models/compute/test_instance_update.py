...
from cloudcafe.compute.events.models.compute.instance_update import InstanceUpdate
...
class BaseInstanceActionsTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.instance_update_dict.update(cls.base_instance_update_dict)

        cls.instance_update_obj = InstanceUpdate._dict_to_obj(
            cls.instance_update_dict)


class InstanceUpdateTest(BaseInstanceActionsTest):
