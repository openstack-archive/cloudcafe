...
from metatests.cloudcafe.compute.security_group_rules.client.responses import SecurityGroupRulesMockResponse
...
class SecurityGroupRulesClientTest(ClientTestFixture):
    ...
    def test_create_security_group_rule(self):
        ...
        assert self.mock_response._get_sec_group_rule() == actual_response.content
