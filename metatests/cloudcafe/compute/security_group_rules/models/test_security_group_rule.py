...
class SecurityGroupRuleDomainTest(object):
    ...
    def test_security_group_rule_attributes(self):
        assert str(self.sec_group_rule.from_port) == '80'
        assert str(self.sec_group_rule.to_port) == '8080'
        assert self.sec_group_rule.ip_protocol == 'tcp'
        assert self.sec_group_rule.id == 'bf57c853-cdf2-4c99-9f9a-79b3e9dc13a8'
        assert (self.sec_group_rule.parent_group_id ==
                'b32c047d-5efc-42ab-8476-3ac9f3681af2')
        assert self.sec_group_rule.ip_range.cidr == '0.0.0.0/0'
