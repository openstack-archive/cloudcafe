...
from cloudcafe.networking.nets_subnets_ports_api.models.request.network \
    import NetworkRequest
from cloudcafe.networking.nets_subnets_ports_api.models.response.network \
...
class CreateNetworkTest(unittest.TestCase):
    ...
    def test_json_request(self):
        ...
        expected_json_output = (
            '{"network": {"shared": "test_shared_value", '
...
class ShowNetworkTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.expected_response = NetworkResponse(**show_attrs)
    ...
    def test_json_response(self):
        ...
        response_obj = NetworkResponse()._json_to_obj(api_json_resp)
...
class ShowMultipleNetworksTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        net1 = NetworkResponse(**show_attrs_1)
        net2 = NetworkResponse(**show_attrs_2)
