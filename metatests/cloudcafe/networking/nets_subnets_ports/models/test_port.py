...
from cloudcafe.networking.nets_subnets_ports_api.models.request.port \
    import PortRequest
from cloudcafe.networking.nets_subnets_ports_api.models.response.port \
    import PortResponse
...
class CreatePortTest(unittest.TestCase):
    ...
    def test_json_request_all_attrs(self):
        ...
        expected_json_output = (
            '{"port": {"name": "port_name", "admin_state_up": false, '
...
class UpdatePortTest(unittest.TestCase):
    ...
    def test_json_request(self):
        ...
        expected_json_output = (
            '{"port": {"name": "port_update_name", "admin_state_up": true, '
...
class ShowPortTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.expected_response = PortResponse(**show_attrs)
    ...
    def test_json_response(self):
        ...
        response_obj = PortResponse()._json_to_obj(api_json_resp)
...
class ShowMultiplePortTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        show_attrs_2 = dict(
            ...
            security_groups=[],
            device_id='9ae135f4-b6e0-4dad-9e91-3c223e385824',)
        sub1 = PortResponse(**show_attrs_1)
        sub2 = PortResponse(**show_attrs_2)
...
def suite():
    suite = unittest.makeSuite(ShowMultiplePortTest, 'test')
    return suite
