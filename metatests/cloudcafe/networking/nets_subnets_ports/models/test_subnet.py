...
from cloudcafe.networking.nets_subnets_ports_api.models.request.subnet \
    import SubnetRequest
from cloudcafe.networking.nets_subnets_ports_api.models.response.subnet \
    import SubnetResponse
...
class UpdateSubnetTest(unittest.TestCase):
    ...
    def test_json_request(self):
        ...
        expected_json_output = (
            '{"subnet": {"dns_nameservers": ["test_dnsname1", '
            '"test_dnsname2", "test_dnsname3"], "host_routes": '
            '[{"route1_key2": "route1_value2", "route1_key": "route1_value"}, '
            '{"route2_key2": "route2_value2", "route2_key": "route2_value"}], '
            '"name": "test_subnet_name", "enable_dhcp": true, "gateway_ip": '
            '"test_gateway_ip"}}')
        request_body = self.subnet_model._obj_to_json()
        msg = ('Unexpected JSON Subnet request serialization. Expected {0} '
               'instead of {1}'.format(expected_json_output, request_body))
...
class ShowSubnetTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.expected_response = SubnetResponse(**show_attrs)
    ...
    def test_json_response(self):
        ...
        response_obj = SubnetResponse()._json_to_obj(api_json_resp)
...
class ShowMultipleSubnetTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        show_attrs_2 = dict(
            ...
            host_routes=[], cidr='192.0.0.0/8',
            id_='54d6f61d-db07-451c-9ab3-b9609b6b6f0b')
        sub1 = SubnetResponse(**show_attrs_1)
        sub2 = SubnetResponse(**show_attrs_2)
