...
from cloudcafe.networking.lbaas.lbaas_api.clients.pool.client \
    import PoolsClient
from cloudcafe.networking.lbaas.lbaas_api.models.request.pool \
    import CreatePool, UpdatePool
from cloudcafe.networking.lbaas.lbaas_api.models.response.pool_tmp \
    import Pool, Pools
